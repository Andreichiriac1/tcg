    ...
    <head>
        ...
        <style>
            ...
            form input{
                ...
                border: none;
                outline: none;
                background-color: rgba( 23, 91, 105, .1);
                padding: 0px 10px;
                border-bottom: 1px solid #175B69;
            ...
            <div class="container">
                <div class="row">
                    <div class=" col-md-8 ml-auto mr-auto">
                        <h1 class='text-uppercase consultancy' style="font-size: 1.9rem;">INVESTMENT</h1>
                        <p style="font-size: 1rem;">LAND & BUILDING OPPORTUNITIES. SALE & ACQUISITION</p>
                     </div>
                </div>
            </div>
        </div><!--page title end-->
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="servicesPagesText">
                        <h1 class="h5">We keep in mind all the time that continuity matters to you. That’s why we continuously update our Investment Portfolio to match as many needs as a fine developer like you has.</h1>
                        <p><br>
                        Everything from small land plots worth 1M € or less to large plots worth more than 10M €, income producing buildings, off-market opportunities, sets of apartments to invest in etc.: you can find them all in The Concept Group portfolio.
                        <br>
                        <br>
                        Feel free to check our offers through our experienced Investment Managers and to build strategies on any of them.    
                        </p><br>
                         <p>Our Investment Service comprises also of:</p>    
                        <ul>
                            <li>Built-in P&L per each plot</li>
                            <li>Multiple Financial Scenarios depending on your risk profile</li>
                            <li>Identifying Target Audience</li>
                            <li>Market Studies (on demand)</li>
                        </ul>    
                        <p>Looking for new Investment opportunities, dealt in a proper way? <a href="contact.php">Contact us</a> and let’s work together on this</p>           
                    </div>
                </div>
                <div class="col-md-4">
                    <form action="">
