    ...
    <head>
        ...
        <style>
            ...
            form input{
                ...
                border: none;
                outline: none;
                background-color: rgba( 225, 131, 117, .1);
                padding: 0px 10px;
                border-bottom: 1px solid #E18375;
            ...
            <div class="container">
                <div class="row">
                    <div class=" col-md-8 ml-auto mr-auto">
                        <h1 class='text-uppercase consultancy' style="font-size: 1.9rem;">SALES MANAGEMENT</h1>
                        <p style="font-size: 1rem;">YOUR TEAMS. OUR MANAGERS</p>
                     </div>
                </div>
            </div>
        </div><!--page title end-->
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="servicesPagesText">
                        <h1 class="h5">Do you already have a Sales Team in place and you find them difficult to manage? Or the results are not yet the ones you aspire to? </h1><br>
                        <p>
                        No worries, we are the first Sales Organization in Real Estate that accepted the challenge of creating value and basically offering our knowledge to our partners only from a Management position, without providing also the Dedicated Sales Teams.
                        </p><br>
                         <p>Our Sales Management Service comprises of:</p><br>
                        <ul>
                            <li>An experienced Sales Manager managing the team side by side with you (or totally delegated to us - you decide)</li>
                            <li>Daily, Weekly & Monthly Reports</li>
                            <li>Strategic Advisory from our Sales Managers</li>
                            <li>Reviewing the Sales Process</li>
                            <li>Integrating the Sales Process in Efficient Online Tools (CRMs, Calendars, Reports, Drive)</li>
                            <li>Reviewing Sales Strategy</li>
                            <li>Reviewing the Marketing Plan and how it is implemented and monitored</li>
                            <li>Assistance in Pricing Strategy</li>
                            <li>Sales Training (for your teams)</li>
                        </ul>    
                        <p>Need a professional Sales Management? We can help. <a href="contact.php">Call us</a></p>  <br><br>         
