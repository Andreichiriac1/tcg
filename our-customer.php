...
<html lang="en">
    ...
    <body data-spy="scroll" data-darget=".navbar-seconday">
                ...
                <div  id="navbarNavDropdown" class="navbar-collapse collapse">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown active">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                <li><a href="our-customer.php" class="dropdown-item active">OUR CUSTOMERS</a></li>
        ...
        <div class="page-titles-img title-space-lg bg-parallax parallax-overlay" data-jarallax='{"speed": 0.2}' style='background-image: url("img/customerBg.jpg")'>
            <div class="container">
                <div class="row">
                    <div class=" col-md-8 ml-auto mr-auto">
                        <h1 class='text-uppercase' style="font-size: 1.9rem;">OUR CUSTOMERS</h1>
                        <p style="font-size: 1rem;">TO WHOM WE THANK FOR BELIEVING IN US</p>
                     </div>
                </div>
            </div>
        </div><!--page title end-->
        ...
        <div class="container pt90 pb50">
            <p class="lead text-center" style="font-weight: bold; font-size: 1.5rem;">
            We have been privileged to work with some of the finest 
            <br>
            Real Estate developers in Central & Eastern Europe. 

            </p> <br>
            <p class="text-center">
            From small to large companies, we are dedicated to partnering with our clients to determine and address the specific needs of their organization & projects.
<br>Here you can find a part of them, together with customers from other fields besides Real Estate, who benefited from our Sales & Marketing Services.
