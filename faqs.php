...
<html lang="en">
    ...
    <body data-spy="scroll" data-darget=".navbar-seconday">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown active">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                ...
                                <li><a href="faqs.php" class="dropdown-item active">FAQs</a></li>
                            </ul>
                        </li>
                        <!--  -->
        ...
        <div class="page-titles-img title-space-lg bg-parallax parallax-overlay" data-jarallax='{"speed": 0.2}' style='background-image: url("img/faqBg.jpg")'>
            <div class="container">
                <div class="row">
                ...
                <div class="card-header accordion-header" role="tab" id="headingOne">
                    <h5 class="mb-0">
                        <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                            What do you mean by Sales Outsourcing?
                        </a>
                    </h5>
                </div>
...
<br>It’s called “outsourcing” because the Sales Team acts like your internal Sales Department with the major benefit of coming from a Sales Organization, providing training, tools and a management structure with focus only in the provision of performant sales services.
                ...
                <div class="card-header accordion-header" role="tab" id="headingTwo">
                    <h5 class="mb-0">
                        <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                            Do you cross-promote other offers to my projects’ clients?
                        </a>
                    </h5>
                </div>
            ...
            <div class="card mb10">
                <div class="card-header accordion-header" role="tab" id="headingFour">
                    <h5 class="mb-0">
                        <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseFour" aria-expanded="false" aria-controls="collapseThree">
                            What kind of consultancy pre-development do you offer?
            ...
            <div class="card mb10">
                <div class="card-header accordion-header" role="tab" id="headingFive">
                    <h5 class="mb-0">
                        <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseFive" aria-expanded="false" aria-controls="collapseThree">
                            Do you invest in marketing or is it our job?
                        </a>
                    </h5>
                </div>
                <div id="collapseFive" class="collapse" role="tabpanel" aria-labelledby="headingFive">
                    <div class="card-body">
                        ...
                        <br>The effectiveness of the marketing budget will be measured continuously through reports and meetings in which we’ll follow a set of strategic KPIs, important for the success of the project.
                    </div>
                </div>
            </div>
