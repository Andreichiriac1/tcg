...
<html lang="en">
    ...
    <body data-spy="scroll" data-darget=".navbar-seconday">
                ...
                <div  id="navbarNavDropdown" class="navbar-collapse collapse">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown active">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                <li><a href="on-sale.php" class="dropdown-item active">On Sales</a></li>
        ...
        <div class="page-titles-img title-space-lg bg-parallax parallax-overlay" data-jarallax='{"speed": 0.2}' style='background-image: url("img/saleBg.jpg")'>
            <div class="container">
                <div class="row">
                    <div class=" col-md-8 ml-auto mr-auto">
                        <h1 class='text-uppercase'>ON SALES</h1>
                        <p>FREE EDUCATIONAL CONTENT</p>
                     </div>
                </div>
            </div>
        </div><!--page title end-->
        ...
        <div class="container pt50 pb50">
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="card mb30">
                        <img class="card-img-top img-fluid" src="images/img1.jpg" alt="Card image cap">
                        <div class="card-body">
                            <h4 class="card-title">
                                Card title
                            </h4>
