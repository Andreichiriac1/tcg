    ...
    <head>
        ...
        <style>
            ...
            form input{
                ...
                border: none;
                outline: none;
                background-color: rgba( 180, 42, 39, .1);
                padding: 0px 10px;
                border-bottom: 1px solid #B42A27;
            ...
            <div class="container">
                <div class="row">
                    <div class=" col-md-8 ml-auto mr-auto">
                        <h1 class='text-uppercase consultancy' style="font-size: 1.9rem;">SOCIAL MEDIA</h1>
                        <p style="font-size: 1rem;">IF YOU’RE NOT ON SOCIAL MEDIA, YOU DON’T EXIST</p>
                     </div>
                </div>
            </div>
        </div><!--page title end-->
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="servicesPagesText">
                        <h1 class="h5">You like it or not, this is the truth. You can never underestimate the power of Social Media in the context in which humankind adopts new technologies at a staggering pace.</h1><br>
                        <p>
                        Real Estate makes no exception. Most of your audience is there. You just need to tap it with the right message at the right time.
                        <br>
                        Again, the key in Social Media is not only the creativity of the campaigns, but the implementation and the monitoring of the results. Again our Sales Managers can provide help in order to be sure that your money is well spent with an efficient outcome.
                        </p> <br>
                        <p>Our Social Media Services comprise:</p> 
                        <ul>
                            <li>Content Creation</li>
                            <li>Setting Up Target Audience</li>
                            <li>Promotion</li>
                            <li>Monitoring Results (reach, engagement, leads)</li>
                            <li>Video content (on demand) - interviews, construction status</li>
                            <li>Podcasts (on demand)</li>
                        </ul> 
                         
                        <p>Looking for your brand to be socially active? <a href="contact.php">Contact us</a></p> <br><br>          
