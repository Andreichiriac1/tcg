    ...
    <head>
        ...
        <style>
            ...
            form input{
                ...
                border: none;
                outline: none;
                background-color: rgba( 150, 157, 232, .1);
                padding: 0px 10px;
                border-bottom: 1px solid #969DE8;
            ...
            <div class="container">
                <div class="row">
                    <div class=" col-md-8 ml-auto mr-auto">
                        <h1 class='text-uppercase consultancy 'style="font-size: 1.9rem;">CONSULTANCY</h1>
                        <p style="font-size: 1rem;">IN PRE-DEVELOPMENT OR DURING DEVELOPMENT</p>
                     </div>
                </div>
            </div>
        </div><!--page title end-->
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="servicesPagesText">
                        <h1 class="h5">Your project deserves the help of well-trained professionals, with a great foothold in the local Real Estate market. </h1><br>
                        <p>
                        Either if you didn’t start the project already (so you are in Pre-Development Phase) or you already started it (and you are in the Development Stage), we can provide great professionals with years or decades of experience, to assist you through the entire development process on the Marketing & Sales side (be it Project Design, Units Mix, Pricing Strategy. Launching Strategy, Financial Scenarios, Strategic Sales Management, Sales Training).
                        </p><br>
                         <p>Feel free to access our Consultancy Service (paid monthly, weekly or hourly), which comprises:</p>    
                        <ul>
                            ...
                            <li>Sales Training (for your teams)</li>
                            <li>Sales Strategy optimization</li>
                            <li>New Investment Opportunities (new land plots for development)</li>
                        </ul>    
                        <p>Need an honest and straightforward Strategic Consultant? We’ll provide you one <a href="contact.php">Call us</a></p>  <br><br>         
                        ...
                        <ul class="clients-grid mb0 clearfix">
                            ...
                            <li><img  style="height: 120px; padding: 10px; text-align: center" src="clients/Green Future Group/green.png" class="img-fluid" alt="Clients"></li>
