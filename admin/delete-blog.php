<?php
    ...
    if(isset($_GET["delete"]) && $_GET["delete"] == 'true'){
        // Delete Photo
        $photo = "SELECT * FROM `blog` WHERE `id` = '$id'";
        $photoQuery = mysqli_query($connect, $photo);
        while($bg = mysqli_fetch_array($photoQuery)){
            unlink($bg['bg']);
        }

        $delete = "DELETE FROM `blog` WHERE `id` = '$id'";
        mysqli_query($connect, $delete) or die(mysqli_error($connect));
          ...
          <div class="page-wrapper" id="page-wrapper">
            ...
            <main class="content">
                ...
                <div class="page-content">
                     <div class="container-fluid">
                         <h1>Esti sigur ca vrei sa stergi blog-ul ?</h1>
                <?php
                    ...
                    while($row = mysqli_fetch_array($query)){
                        echo '
                                ...
                                <a href="dashboard.php" class="btn btn-primary">Inapoi</a> 
                                <a href="delete-blog.php?id='. $row["id"] . '&delete=true" class="btn btn-primary">Sterge</a> ';
                    }
                ?>
                    </div>
                </div><!-- main end-->
